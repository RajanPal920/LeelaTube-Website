      ...
      <section className="page-hero">
        ...
        <div className="page-hero__image-wrap">
          <img
            ...
            alt="Leela Tubes Facility - Resources and Technical Information"
        ...
        <div className="container page-hero__content">
          ...
          <p>
            Product catalogues, technical specifications and quality documents —
      ...
      <section className="section resources-grid-section">
        <div className="container">
          ...
          >
            ...
            <h2 className="display-md" style={{ margin: "12px 0 16px" }}>
              Documentation &amp; Downloads
            </h2>
            <p className="body-lg">
              Technical documentation is available on request. Submit your
              enquiry and our team will provide the relevant product
              information, specifications or quality documents.
            </p>
          </div>
          ...
          <div className="resources-grid">
            {RESOURCE_SECTIONS.map((r) => (
              <div
                className={`resource-card card resource-card--${r.status}`}
                key={r.title}
              >
                ...
                <div className="resource-card__footer">
                  {r.to ? (
                    <Link
                      to={r.to}
                      className="btn btn--primary resource-card__btn"
                    >
                    ...
                    <Link
                      to="/contact"
                      className="btn btn--outline-green resource-card__btn"
                    >
                      {r.label}
                    </Link>
                  )}
