...
const APPLICATIONS = [
  'Decorative Frameworks', 'Architectural Features', 'Automobile Industry',
  'Furniture Manufacturing', 'Dairy Equipment', 'Special Purpose Fabrications',
  ...
  return (
    <ProductPage
      product={{
        ...
        description: 'ERW stainless‑steel oval tubes for specialised applications, manufactured to customer requirements.',
        longDescription:
