...
const APPLICATIONS = [
  'Petrochemical Piping', 'Chemical Processing', 'Pharmaceutical Plants',
  'Fertilizer Industry', 'Oil Processing', 'Sugar Mills',
  'Dairy Equipment', 'Hospital Furniture Fabrication', 'Automobile Components',
  ...
  return (
    <ProductPage
      product={{
        ...
        description: 'ERW stainless‑steel round tubes manufactured according to customer requirements and specifications.',
        longDescription:
