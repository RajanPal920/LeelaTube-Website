...
const GRADE_DATA = {
  ...
  202: {
    ...
    description:
      "202 stainless steel is a lower-cost alternative to 304, using manganese and nitrogen instead of nickel to maintain mechanical properties. It offers exceptional strength, good corrosion resistance, and excellent toughness at low temperatures.",
    longDescription:
  ...
  "316L": {
    ...
    description:
      "316L is the low carbon version of 316 stainless steel, offering improved weldability and resistance to intergranular corrosion. It provides resistance to a wide variety of mild to moderately corrosive environments with excellent surface finish.",
    longDescription:
  ...
  321: {
    ...
    fullName:
      "Stainless Steel 321 / 321H / 1.4541 / 1.4878 / UNS S32100 / S32109 Welded Pipes",
    category: "Stainless Steels",
    image: "/images/grades/321-welded-pipes.jpg",
    description:
      "321 stainless steel is stabilized with titanium to prevent chromium carbide precipitation and intergranular corrosion, making it suitable for high-temperature applications. It offers superior resistance to pitting, crevice corrosion and stress corrosion cracking.",
    longDescription:
  ...
  409: {
    ...
    description:
      "409 stainless steel is a ferritic grade with good corrosion resistance and excellent formability, commonly used in automotive exhaust systems. It offers high-temperature corrosion resistance and good mechanical properties.",
    longDescription:
...
export default function GradeDetail() {
  ...
  const categoryName = grade.category || "Stainless Steel";

  // Render function for sidebar sections (Chemical Composition, Physical Properties, Navigation, CTA)
  const renderSidebarSections = () => (
    <>
      {/* ✅ Chemical Composition */}
      <div className="grade-sidebar-section grade-composition-wrapper">
          ...
          <table className="grade-composition-table">
            <tbody>
              {Object.entries(grade.chemicalComposition).map(
                ([element, value]) => (
                  <tr key={element}>
                    <td className="grade-composition-element">{element}</td>
      ...
      {grade.physicalProperties && (
        <div className="grade-sidebar-section grade-physical-wrapper">
          <h3
          ...
          <div className="grade-physical-card card">
            <table className="grade-physical-table">
              <tbody>
                {Object.entries(grade.physicalProperties).map(
                  ([property, value]) => (
                    <tr key={property}>
                      <td className="grade-physical-element">
                        {property
                          .replace(/([A-Z])/g, " $1")
                          .replace(/^./, (str) => str.toUpperCase())}
                      </td>
                      <td className="grade-physical-value">{value}</td>
                    </tr>
                  ),
                )}
              </tbody>
      ...
      {/* ✅ Navigation - Welded Pipes */}
      <div className="grade-sidebar-section grade-navigation-wrapper">
      ...
      {/* ✅ CTA Buttons */}
      <div className="grade-sidebar-section grade-cta-wrapper">
        <Link
          to="/quote"
        ...
        <div className="container">
          <div className="grade-detail-grid">
            ...
            <div className="grade-detail-main">
              ...
              {/* ✅ MOBILE: Chemical Composition - Pehle yahan dikhega */}
              <div className="grade-composition-wrapper mobile-only">
                <h3
                  className="heading-md"
                  style={{ marginTop: "32px", marginBottom: "20px" }}
                >
              ...
              {/* ✅ MOBILE: Physical Properties */}
              {grade.physicalProperties && (
                <div className="grade-physical-wrapper mobile-only">
                  <h3
                    className="heading-md"
                    style={{ marginTop: "32px", marginBottom: "20px" }}
                  >
              ...
              {/* ✅ MOBILE: Navigation - Welded Pipes */}
              <div className="grade-navigation-wrapper mobile-only">
                <div className="grade-navigation">
                  <h4 className="grade-nav-title">Welded Pipes</h4>
                  <div className="grade-nav-list">
                    {GRADE_IDS.map((id) => {
              ...
              {/* ✅ MOBILE: CTA Buttons */}
              <div className="grade-cta-wrapper mobile-only">
                <Link
                  to="/quote"
                  className="btn btn--primary"
                  style={{ width: "100%", justifyContent: "center" }}
              ...
              {grade.mechanicalProperties && (
                <>
                  ...
                  <div className="grade-mechanical-grid">
                    ...
                    {grade.mechanicalProperties.heatTreatingTemperature && (
                      <div className="grade-mechanical-item">
                        <span className="grade-mechanical-label">
                    ...
                    {grade.mechanicalProperties.brinellHardness && (
                      <div className="grade-mechanical-item">
                        <span className="grade-mechanical-label">
                          Brinell Hardness
                        </span>
                    ...
                    {grade.mechanicalProperties.rockwellHardness && (
                      <div className="grade-mechanical-item">
                        <span className="grade-mechanical-label">
                          Rockwell Hardness
                        </span>
              ...
              {grade.equivalentGradesH && (
                <>
                  ...
                  <div className="grade-equivalent-grid">
                    {Object.entries(grade.equivalentGradesH).map(
                      ([standard, value]) => (
                        <div className="grade-equivalent-item" key={standard}>
                          <span className="grade-equivalent-standard">
                            {standard}
              ...
              {/* Weight Chart */}
              {grade.weightChart && grade.weightChart.length > 0 && (
                <>
                  <h3
                    className="heading-md"
                    style={{ marginTop: "32px", marginBottom: "20px" }}
                  ...
                  <div className="grade-weight-wrapper">
                    <table className="grade-weight-table">
                      <thead>
                        <tr>
                          <th>NPS</th>
                      ...
                      <tbody>
                        {grade.weightChart.map((item, index) => (
                          <tr key={index}>
                            <td>{item.nps}</td>
                            <td>{item.od}</td>
                            <td>{item.wallThickness}</td>
                            <td>{item.schedule}</td>
                            <td>{item.kgMtr}</td>
                            <td>{item.lbFt}</td>
                          </tr>
              ...
              <div className="grade-cities-tags">
                {CITIES_SUPPLIED.map((city, index) => (
                  <span className="grade-city-tag" key={`${city}-${index}`}>
                  ...
                  return (
                    ...
                    >
                      {countryCode ? (
                        ...
                        <span className="country-flag-fallback">🌐</span>
                      )}
                      <span>{country}</span>
                    </span>
                  );
            ...
            {/* ============================================================
                RIGHT COLUMN - Sidebar (Desktop Only - Hidden on Mobile)
                ============================================================ */}
            <div className="grade-detail-sidebar desktop-only">
