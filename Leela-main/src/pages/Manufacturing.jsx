    ...
    <div className="mfg-page">
      ...
      <section className="page-hero">
        <div className="container page-hero__content">
          ...
          <p>A high-tech ERW stainless‑steel tube manufacturing facility in Daman, India.</p>
        </div>
      </section>
      ...
      <section className="section mfg-overview">
        <div className="container mfg-overview__grid">
          <div className="mfg-overview__content">
            ...
            <h2 className="display-md" style={{ margin: '12px 0 24px' }}>Manufacturing at Daman</h2>
            <p className="body-lg">
              Leela Tubes Pvt. Ltd. operates a high-tech manufacturing facility located at
              Village Dabhel, Daman — a Union Territory of India with a strong industrial
              manufacturing base. The plant is designed to produce ERW stainless‑steel pipes
              and tubes that satisfy demanding user requirements across multiple industries.
            </p>
            <p className="body-lg" style={{ marginTop: '16px' }}>
              The facility combines advanced manufacturing equipment with experienced technical
              personnel and complete testing capability to ensure that products consistently
              meet the specifications and requirements defined by customers.
            </p>
            <div className="mfg-overview__tags" style={{ marginTop: '28px' }}>
              {['ERW Manufacturing', 'Daman, India', 'Advanced Equipment', 'Complete Testing', 'Spacious Warehouse'].map((t) => (
      ...
      {/* Capabilities grid */}
      <section className="section mfg-capabilities" style={{ background: 'var(--off-white)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <p className="section-label">Infrastructure</p>
            <h2 className="display-md" style={{ marginTop: '12px' }}>Manufacturing Infrastructure</h2>
          </div>
          <div className="mfg-cap-grid">
            {CAPABILITIES.map((cap) => (
              <div className="mfg-cap-card card" key={cap.title}>
                <div className="mfg-cap-card__icon">{cap.icon}</div>
                <h3 className="heading-sm mfg-cap-card__title">{cap.title}</h3>
      ...
      <section className="section mfg-products">
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h2 className="display-md" style={{ marginTop: '12px' }}>ERW Stainless Steel Tube Profiles</h2>
            <p className="body-lg" style={{ maxWidth: '580px', margin: '16px auto 0' }}>
              The facility manufactures four tube profiles, each to customer-specified dimensions
              and requirements.
            </p>
          </div>
          <div className="mfg-profiles-grid">
            {[
              { name: 'Round Tubes',       shape: '●', to: '/products/round-tubes' },
              { name: 'Square Tubes',      shape: '■', to: '/products/square-tubes' },
              { name: 'Rectangular Tubes', shape: '▬', to: '/products/rectangular-tubes' },
              { name: 'Oval Tubes',        shape: '⬭', to: '/products/oval-tubes' },
            ].map((p) => (
              <Link to={p.to} key={p.name} className="mfg-profile-card card">
                <div className="mfg-profile-card__shape">{p.shape}</div>
      ...
      {/* Note on process */}
      <section className="section--sm mfg-note-section" style={{ background: 'var(--green-pale)' }}>
        <div className="container mfg-note-inner">
          <div className="mfg-note-icon">📋</div>
          <div>
            <h3 className="heading-sm" style={{ marginBottom: '8px' }}>Manufacturing Process Details</h3>
            <p className="body-md">
              Detailed information on manufacturing processes, step-by-step production methodology
              and testing procedures is available on request from Leela Tubes. Please submit an
              enquiry with your requirement.
            </p>
          </div>
