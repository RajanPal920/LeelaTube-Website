...
export default function Quote() {
  ...
  const handleSubmit = (e) => {
    ...
    const emailSubject = `Quote Request - ${form.product || "General Enquiry"}`;
...
Material/Grade: ${form.grade || "N/A"}
Size / OD:      ${form.od || "N/A"}
Wall Thickness: ${form.wallThickness || "N/A"}
Length:         ${form.length || "N/A"}
Quantity:       ${form.quantity || "N/A"}
Standard:       ${form.standard || "N/A"}
...
========================================
Sent from Leela Tubes Website — Request a Quote Form
    `.trim();

    // ── Gmail Web Compose (Recommended — opens directly in browser) ──
    const gmailLink = `https://mail.google.com/mail/?view=cm&fs=1&to=${emailTo}&su=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;

    // ── Alternative: Default email client (Outlook, Mail, etc.) ──
      ...
      <div className="quote-page">
        ...
        <section className="section">
          ...
          >
            ...
            <h2 className="display-md" style={{ margin: "24px 0 16px" }}>
              Enquiry Submitted
            </h2>
            <p className="body-lg">
    ...
    <div className="quote-page">
      <section className="page-hero">
        ...
        <div className="container page-hero__content">
          ...
          <p>
            Send us your requirement and our team will respond with product
          ...
          <aside className="quote-sidebar">
            ...
            <div className="quote-sidebar__card card quote-sidebar__contact">
              ...
              <a
                ...
                className="quote-sidebar__email"
            ...
            >
              ...
              <fieldset className="quote-fieldset">
                ...
                <div className="form-group" style={{ marginBottom: "16px" }}>
                  <label className="form-label" htmlFor="quote-product">
                    Product *
                  </label>
                  <select
                    id="quote-product"
                ...
                <div className="form-grid-2">
                  <div className="form-group">
                    <label className="form-label" htmlFor="quote-grade">
                      Material / Grade
                    </label>
                    <input
                      id="quote-grade"
                      ...
                      value={form.grade}
                      onChange={handleChange}
                      placeholder="e.g. SS 304, 316L, or as required"
                    />
                  </div>
                  <div className="form-group">
                    <label className="form-label" htmlFor="quote-od">
                      Size / OD
                    </label>
                    <input
                      id="quote-od"
                      ...
                      value={form.od}
                      onChange={handleChange}
                      placeholder="e.g. 25 mm OD or as required"
                    />
                  </div>
                  <div className="form-group">
                    <label className="form-label" htmlFor="quote-wall">
                      Wall Thickness
                    </label>
                    <input
                      id="quote-wall"
                      ...
                      onChange={handleChange}
                      placeholder="e.g. 2 mm or as required"
                    />
                  </div>
                  <div className="form-group">
                    <label className="form-label" htmlFor="quote-length">
                      Length
                    </label>
                    <input
                      id="quote-length"
                      ...
                      value={form.length}
                      onChange={handleChange}
                      placeholder="e.g. 6 m or as specified"
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      value={form.quantity}
                      onChange={handleChange}
                      placeholder="e.g. 500 kg, 100 pieces"
                    />
                  </div>
                  <div className="form-group">
                    <label className="form-label" htmlFor="quote-standard">
                    ...
                    <input
                      ...
                      value={form.standard}
                      onChange={handleChange}
                      placeholder="e.g. as per drawing or standard"
                    />
                  </div>
                </div>
                <div className="form-group">
                  <label className="form-label" htmlFor="quote-application">
                    Application
                  </label>
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Intended use or industry"
                  />
                </div>
              </fieldset>
              ...
              <fieldset className="quote-fieldset">
                ...
                <div className="form-group" style={{ marginBottom: "16px" }}>
                  ...
                  <textarea
                    ...
                    value={form.message}
                    onChange={handleChange}
                    placeholder="Describe your requirement, any special conditions, or other details..."
                  />
                </div>
                <div className="form-group">
                  <label className="form-label" htmlFor="quote-file">
                    Upload Drawing / Specification / PO / Requirement
                  </label>
                  ...
                  <p className="body-sm" style={{ marginTop: "6px" }}>
                    Accepted: PDF, DWG, DXF, DOC, XLS, JPG, PNG
                  </p>
                </div>
              </fieldset>
