    ...
    <div className="industries-page">
      <section className="page-hero">
        ...
        <div className="page-hero__image-wrap">
          <img
            ...
            alt="Stainless Steel Tubes for Multiple Industries"
        ...
        <div className="container page-hero__content">
          ...
          <p>
            ERW stainless‑steel tubes trusted across nine industries for
            corrosion resistance, hygiene and long service life.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="industries-intro__grid">
            <div>
              ...
              <h2 className="display-md" style={{ margin: "12px 0 0" }}>
                Serving Industrial Requirements Since 2000
              </h2>
            </div>
            <p className="body-lg">
              Leela Tubes' ERW stainless‑steel pipes and tubes are used across a
              wide range of industries requiring corrosion resistance,
              dimensional precision and long service life. Products are
              manufactured to customer specifications suited to each
              application.
            </p>
          </div>
        </div>
      ...
      <section className="section industries-section">
        <div className="container">
          <div className="industries-section__header">
            ...
            <h2 className="display-md">Nine Industries, One Standard</h2>
            <p
              className="body-lg"
              style={{ maxWidth: "600px", margin: "16px auto 0" }}
            >
              Our ERW stainless-steel tubes are trusted across diverse
              industries for their corrosion resistance, hygiene and long
              service life.
            </p>
          </div>
          ...
          <div className="industries-grid">
            {INDUSTRIES.map((industry) => (
              <div className="industry-flip-card" key={industry.name}>
                {/* FRONT SIDE (Text) */}
                <div
                  className="industry-flip-card__front"
                  style={{ backgroundColor: industry.color }}
                >
                  <div className="industry-flip-card__icon">
                    {industry.icon}
                  </div>
                  <h3 className="industry-flip-card__title">{industry.name}</h3>
                  <p className="industry-flip-card__desc">{industry.desc}</p>
                  <span className="industry-flip-card__link">
                    Enquire for this Industry →
                  </span>
                </div>

                {/* BACK SIDE (Image) */}
                <div className="industry-flip-card__back">
                  <img
                    src={industry.image}
                    alt={industry.alt}
                    className="industry-flip-card__back-img"
                  />
                  <div className="industry-flip-card__back-overlay">
                    <h3 className="industry-flip-card__back-title">
                      {industry.name}
                    </h3>
                  </div>
                </div>
      ...
      >
        <div className="container" style={{ textAlign: "center" }}>
          <p
            className="section-label section-label--white"
          ...
          >
            Our products are engineered to customer requirements and
            specifications. If you have a requirement not covered above, please
            submit it and our team will respond.
          </p>
