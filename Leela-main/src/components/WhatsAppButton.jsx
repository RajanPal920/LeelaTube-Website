...
export default function WhatsAppButton() {
  ...
  return (
    <div className="floating-cta">
      ...
      <a
        href={`tel:${callNumber}`}
        className="floating-cta__btn floating-cta__btn--phone"
        aria-label="Call Leela Tubes"
        id="phone-cta-btn"
      >
        <span className="floating-cta__tooltip">Call Us</span>
        <div className="floating-cta__icon-wrap">
          <svg
      ...
      <a
        ...
        id="whatsapp-cta-btn"
      >
        <span className="floating-cta__tooltip">Chat on WhatsApp</span>
        <div className="floating-cta__icon-wrap">
          <svg
            className="floating-cta__icon"
            viewBox="0 0 24 24"
